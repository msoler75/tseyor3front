<template>
  <div class="flex flex-col items-center">
    ...
    <section
      id="blog-info"
      class="bg-blue-gray-900 w-full mt-6 py-9 lg:mt-0 px-1 sm:px-6 md:px-10"
    >
      <div
        class="max-w-3xl mx-auto flex justify-center items-center sm:justify-between flex-wrap"
      >
        <div
          class="mx-auto flex flex-col justify-center items-center sm:w-1/2 lg:w-1/3"
        >
