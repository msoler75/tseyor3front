  ...
  <div class="max-w-3xl">
    ...
    <Grid class="my-7 text-center">
          <Card class="px-5 py-7">
              ...
              <p class="text-diminished mt-4"><i class="fas fa-info-circle"/> Información sobre el muular</p>
          </Card>
          <Card class="px-5 py-7">
              <h3>Donar</h3>
     ...
     <Card class="px-5 py-7 w-full my-7">
        ...
        <ul class="list-none ml-6">
          ...
          <li><i class="fas fa-check-circle rounded-full text-blue-400 mr-3"/>...</li>
        </ul>
