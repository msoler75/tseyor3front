...
(function (global, factory) {
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOPLinkTag, md5) {
      ...
      diagFrame.onload = function () {
        ...
        diagFrame.contentDocument.head.appendChild(scriptOPLinkTag);
    ...
    for (var i = 0; i < linkTags.length; i++) {
      ...
      var md5FoPLink = md5ForNode(linkTags[i]);
      linkUnderTest.setAttribute(md5Attr, md5FoPLink);
      cssByMD5[md5FoPLink] = linkTags[i];
      runDiag(linkUnderTest, md5FoPLink);
    }
